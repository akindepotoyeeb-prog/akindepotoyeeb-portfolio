    ...
    <section className="detail-page section-p1">
        ...
        <div className="detail-card">
          ...
          <ul>
            ...
            <li>
              <h5>Architecture</h5>
              <p>
                Design scalable models, database structures, and API endpoints.
              </p>
            </li>
            <li>
              <h5>Development</h5>
              <p>
                Build secure and maintainable backend functionality using modern
                development practices.
              </p>
            </li>
            <li>
              <h5>Testing</h5>
              <p>Verify functionality, data integrity, and API performance.</p>
            </li>
            <li>
      ...
      <div className="work-with-me animate-moveup">
        <div>
          ...
          <p>
            I build backend systems that provide a strong foundation for modern
            applications. My goal is to develop secure, scalable, and efficient
            solutions that support seamless user experiences and long-term
            business growth.
          </p>
        </div>
        <div>
