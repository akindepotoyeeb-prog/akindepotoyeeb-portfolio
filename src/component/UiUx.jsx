...
export default function UiUx() {
  return (
    <section style={{ width: "100%" }}>
      <div style={{ width: "100%", backgroundColor: "var(--bg-color)", zIndex: "10", position: "sticky", top: "0", right: "0"}}>
      ...
      <div className="detail-page section-p1">
        <div className="pro-details animate-moveup">
          <div className="detail-top">
            ...
            <p>
              My passion for UI/UX design comes from understanding how
              thoughtful design can improve everyday digital experiences. I
              enjoy transforming ideas into functional, user-friendly interfaces
              through research, wireframing, prototyping, and visual design.
              Every project is an opportunity to create meaningful experiences
          ...
          <div className="detail-card">
            ...
            <ul>
              ...
              <li>
                <h5>prototype</h5>
                <p>
                  Building interactive prototypes to simulate the user
                  experience.
                </p>
              </li>
              <li>
        ...
        <div className="work-with-me animate-moveup">
          <div>
            ...
            <p>
              I believe great design goes beyond aesthetics. My goal is to
              create digital products that are intuitive, engaging, and
              impactful while maintaining a balance between user satisfaction
