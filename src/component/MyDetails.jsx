      ...
      <div className="detail-top animate-moveup">
        <div className="dleft">
          <div className="paragaph">
            <div className="ppp">
              ...
              <div className="about-text">
                ...
                <p>
                  ...
                  dedicated to creating digital products that combine beautiful
                  design with powerful functionality. I enjoy transforming ideas
                  into meaningful experiences that solve real-word problems and
            ...
            <p style={{ marginTop: "0" }}>
              ...
              impact. My journey in technology and design is fueled by a desire
              to bridge creativity and functionality, ensuring that every
              product I build is both engaging and effective. with a growth
              mindset and strong attention to detail, I embrace new challenges,
              adapt to evolving technologies, and remain dedicated to delivering
              work that exceeds expectations and creates lasting value.
            </p>
            <h4>My juurney</h4>
            <p>
              My juurney into technology began with a strong interest in
              creativity and problem-solving. As a Mass Communication graduate,
              I develop communication and storytelling skills that later became
              valuable in design and product development. Over time, I expanded
              my expertise into UI/UX design and software development, learning
              how to create both visually appearling interfaces fuctional web
              application
            </p>
            <p>
              Today, I focus on designing and building modern digital solutions
              that are user-friendly, scalable, and impactful.
            </p>
          </div>
        </div>
        <div className="detail-card">
          <div className="detail-copy">
            <h4>My mission</h4>
            <p>
              I enjoy transforming ideas into meaningful experiences that solve
              real-world problems and provide value to users.
            </p>
          </div>
          <div className="detail-copy">
            <h4>What I do</h4>
            ...
            <p>
              ...
              enjoy bringing ideas to life through thoughtful design and clean,
              efficient code.
            </p>
          </div>
        </div>
        ...
        <div>
          <div>
            ...
            <p>
              ...
              <br />
              <strong>
                Westland Polytechnic Ilobu, osun state | Sound Foundation Edtech
                Academy
              </strong>
            </p>
            <p>
              ...
              a better designer and developer.
            </p>
            <p>
