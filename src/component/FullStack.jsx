      ...
      <div className="pro-details animate-moveup">
        <div className="detail-top">
          ...
          <p>
            ...
            functional web applications. From designing intuitive interfaces to
            developing responsive frontends and building secure backend systems,
            I enjoy working across the entire development lifecycle. This
            end-to-end approach helps me create products that are efficient,
        ...
        <div className="detail-card">
          ...
          <ul>
            <li>
              <h5>Discovery</h5>
              <p>
                Understand project goals, user needs, and business requirements.
              </p>
            </li>
            <li>
              <h5>Design</h5>
            ...
            <li>
              ...
              <p>
                Develop responsive, interactive, and accessible user interfaces.
              </p>
            </li>
            <li>
      ...
      <div className="work-with-me animate-moveup">
        <div>
          ...
          <p>
            ...
            while building reliable backend systems that power them. This allows
            me to deliver complete, high-quality solutions from concept to
            deployment with consistency and attention to detail.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            Whether you need a modern website, a business platform, or a custom
            web application, I'm ready to help turn your vision into a secure,
            scalable, and user-friendly solution. Let's create something
            impactful together.
          </p>
        </div>
      </div>
