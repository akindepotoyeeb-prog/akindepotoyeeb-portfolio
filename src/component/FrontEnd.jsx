      ...
      <div className="pro-details animate-moveup">
        <div className="detail-top">
          ...
          <p>
            ...
            combine clean code with exceptional user experiences. My focus is on
            performance, accessibility, and creating interfaces that work
            seamlessly across all devices.
          </p>
          <h4>About Frontend Development</h4>
          <p>
            Frontend development is where creativity meets functionality. I
            enjoy transforming UI/UX designs into fully responsive, interactive
            web applications using modern technologies and best coding
            practices. Every project is built with scalability, maintainability,
        ...
        <div className="detail-card">
          ...
          <ul>
            ...
            <li>
              <h5>Integration</h5>
              <p>
                Connect applications with APIs and external services to deliver
            ...
            <li>
              <h5>Testing</h5>
              <p>
                Ensure responsiveness, browser compatibility, accessibility, and
                performance.
              </p>
            </li>
            <li>
          ...
          <div className="image">
            ...
            <div className="des">
              <div>
                <h5>Outfyt</h5>
                <p>
                  This OutFit website is developed to help user for their outing
                  fit.
                </p>
              </div>
              <a className="preview" href="#" target="_blank">
          ...
          <div className="image">
            ...
            <div className="des">
              <div>
                <h5>Movie Search</h5>
                <p>
                  This website was developed completely to help user search for
                  any movie by name.
                </p>
              </div>
              <a
      ...
      <div className="work-with-me animate-moveup">
        <div>
          ...
          <p>
            ...
            functional, responsive, and optimized for performance. My goal is to
            create digital experiences that deliver value to users while meeting
            business objectives through clean and efficient code.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            Whether it's a landing page, business website, portfolio, or modern
            web application, I'm ready to turn your ideas into fast, responsive,
